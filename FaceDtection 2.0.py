...
while True:
    ...
    img = detectorBody.findPose(img, draw=True)
    ...
    if bboxs:
        ...
        CrossL, img, _ = detectorBody.findDistance(15, 12, img, draw=True)
        CrossR, img, _ = detectorBody.findDistance(16, 11, img, draw=True)
